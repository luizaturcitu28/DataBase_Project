...
<html lang="en">
  ...
  <body>
    <header class="header">
      <a href="#" class="logo"><span>e</span>vents</a>
      <nav class="navbar">
        <a href="#home">home</a>
      ...
      <button class="login-btn" id="open-login-modal">Login</button>
    </header>

    <section class="home" id="home">
      <div class="content">
        <h3>It's time to celebrate the best <span>event company</span></h3>
    ...
    <section class="service" id="service">
      ...
      <div class="box-container">
        <div class="box">
          ...
          <p>paragraf text uhbyvjbjhs jkdnj s...</p>
        </div>
    ...
    <section class="about" id="about">
      ...
      <div class="row">
        ...
        <div class="content">
          ...
          <p>paragraf text fbhbdwnsh dbvhejsndbh duwvjsdbk</p>
          <p>alt paragraf text jhugdjwbs uhssjdhghsj hgydgjsnz</p>
    ...
    <section class="footer">
      <div class="box-container">
        ...
        <div class="box">
          ...
          <a href="#"> <i class="fas fa-envelope"></i> luiza@gmail.com </a>
          <a href="#"> <i class="fas fa-envelope"></i> alexandra@gmail.com </a>
          <a href="#">
            <i class="fas fa-map-marker-alt"></i> bucuresti, romania - 400104
          </a>
        </div>
    ...
    <div id="login-modal" class="modal">
      <div class="modal-content">
        ...
        <h2>Login</h2>
        <form id="login-form" action="components/login.php" method="POST">
